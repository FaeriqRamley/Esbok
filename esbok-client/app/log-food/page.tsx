      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6">
              ...
              {foodForm.image ? (
                <div className="relative w-full h-full">
                  ...
                  <Button
                    ...
                    onClick={() => setFoodForm((p) => ({ ...p, image: null }))}
                  >
                    <X className="w-4 h-4" />
                  </Button>
                </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFoodForm((p) => ({ ...p, expiry: e.target.value }))
            }
            className="border-esbok-border focus:border-esbok-primary"
          />
        </div>
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFoodForm((p) => ({ ...p, pantry: e.target.value }))
            }
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-esbok-border">
          <div>
            ...
            <p className="text-xs text-gray-600 mt-1">
              Allow others to see and take this item
            </p>
          </div>
          <Switch
            checked={foodForm.isShareable}
            onCheckedChange={(c) =>
              setFoodForm((p) => ({ ...p, isShareable: c }))
            }
          ...
          <div className="space-y-6 border-t border-esbok-border pt-6">
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setFoodForm((p) => ({ ...p, description: e.target.value }))
                }
              ...
              <div className="flex flex-wrap gap-2">
                {availableTags.map((tag) => (
                  <Button
                    key={tag}
                    variant={
                      foodForm.tags.includes(tag) ? "default" : "outline"
                    }
                    size="sm"
