        ...
        <div className="px-5">
          <div className="flex gap-2">
            <Button
              ...
              size='sm'
              className={`rounded-full text-xs px-4 ${pantryFilter === 'admin' ? 'bg-esbok-primary text-gray-800 hover:bg-esbok-primary/90' : 'border-esbok-border text-gray-600 hover:bg-gray-50'}`}
            ...
            <Button
              ...
              size='sm'
              className={`rounded-full text-xs px-4 ${pantryFilter === 'joined' ? 'bg-esbok-primary text-gray-800 hover:bg-esbok-primary/90' : 'border-esbok-border text-gray-600 hover:bg-gray-50'}`}
            ...
            <Button
              ...
              size='sm'
              className={`rounded-full text-xs px-4 ${pantryFilter === 'nearby' ? 'bg-esbok-primary text-gray-800 hover:bg-esbok-primary/90' : 'border-esbok-border text-gray-600 hover:bg-gray-50'}`}
